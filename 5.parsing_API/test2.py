...
class LogParser(object): # why object? 
        ...
        with open(self.log_file, 'r') as f:
            for line in f:
                ...
                if len(line_split) > 1:
                    ...
                    minute = timestamp[:13] # Jan 20 03:25:08
                    if minute not in self.log_dict:
                        self.log_dict[minute] = 1 # initialize
                    else:
                        self.log_dict[minute] += 1 # 
